    ...
    <div className="max-w-[1470px] mx-auto">
      ...
      <div className="video-product relative ">
        <div className="rounded-3xl overflow-hidden" style={{ height: "90vh" }}>
          <video
            src="/src/assets/48569-454825064.mp4"
            loop
            autoPlay
            muted
        ...
        <div className="absolute center-box w-[320px]">
          <div className=" bg-[#ff9727] p-4 pb-2 rounded-lg">
            <div className="cursor-pointer">
              ...
              <div className="  h-[250px] p-2 rounded-lg text-center ">
                <img
                  src="/src/assets/Perfume.G03.watermarked.2k.png"
                  alt=""
                  srcSet=""
              ...
              <div className="mb-1 p-1 pt-2">
                ...
                <h2 className="text-[20px] mt-1 div-title title single-line-ellipsis">
                  Amber Wood Edp 100ml Long Last
                </h2>
                <p className="py-2">
                  {" "}
                  <del className="mr-2  text-gray-500">₹ 1800 </del>{" "}
                  <b className="text-[18px]">12600</b>
                </p>
      ...
      <div className="gift py-10 flex justify-between items-end mt-5 w-[1470px]">
        <div className="flex flex-col w-[50%]">
          <i className="text-5xl title font-italic self-start">
            A Gifting Moment{" "}
          </i>
          <p className="w-full text-left mt-6 tracking-wider leading-7 overflow-hidden text-gray-500">
            Step into a realm of luxury and sophistication with My Perfumes.
            Each bottle is a work of art, meticulously designed and adorned with
            intricate details that reflect the essence of the fragrance within.
            With every spritz, your loved ones will be transported to a world of
            captivating aromas, creating memories that will be treasured for a
            lifetime.
          </p>
        </div>
        <div>
          <a
            href="#"
            className="flex whitespace-nowrap  items-center text-black hover:text-[#bc8b57] ml-auto"
          >
            Discover all
            <img
              className="ml-1"
