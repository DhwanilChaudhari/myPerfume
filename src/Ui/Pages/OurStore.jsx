...
export default function () {
  return (
    <>
      <div className=" bg-gray-300 p-9 text-left mx-14 my-4">
        <h2 className="text-[35px]  font-bold">My Perfumes</h2>
        <p className="text-[25px] font-bold">Locate the nearest stores</p>
        <div className="grid grid-cols-3 gap-4 mt-3">
          <div className="flex flex-col">
            <label htmlFor="stateSelect" className="text-left">
              State
            </label>
          ...
          <div className="flex flex-col">
            <label htmlFor="citySelect" className="text-left">
              City
            </label>
      ...
      <div className="flex flex-wrap justify-center  gap-4 ">
        <div div className="border w-[30%] text-left p-6 ">
          ...
          <p className="my-4">+919988776655</p>
        ...
        <div className="border w-[30%] text-left p-6  ">
          ...
          <ul>
            <li>
              No G116A, GF, V3S East Centre, PN 12, Commercial Cplx, Swasthya
              Vihar
            </li>
            <li>Laxmi Ngr</li>
            <li>New Delhi - 110092</li>
